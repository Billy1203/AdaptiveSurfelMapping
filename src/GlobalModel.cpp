                                ...
                                const float depthMax)
{
    ...
    dataProgram->setUniform(Uniform("r0", Config::rzero()));
                                  ...
                                  int isClean)
{
    ...
    conflictProgram->setUniform(Uniform("stereoBorder", Config::depthPad()));
    conflictProgram->setUniform(Uniform("isClean", isClean));
    conflictProgram->setUniform(Uniform("r0", Config::rzero()));
