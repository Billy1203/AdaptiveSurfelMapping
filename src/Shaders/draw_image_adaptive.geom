...
void main()
{
    ...
    {
        vec3 x, y;  // two perpendicular directions


        float meanFocal = ((1.0 / abs(cam.z)) + (1.0 / abs(cam.w))) / 2.0;
        float h = 1.41421356 * meanFocal * vNormRad[0].w / vPosHome[0].z;
...
//        float r0 = 1.f;
        ...
        else
        {
            ...
            //radius = 1 * vNormRad[0].w / (1.0 + 0.41421356 * abs(vNormRad[0].z));
            float radius = r0 * vNormRad[0].w / (1.0 + 0.2* abs(cosAngle));
